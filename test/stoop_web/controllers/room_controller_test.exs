defmodule StoopWeb.RoomControllerTest do
  use StoopWeb.ConnCase

  alias Stoop.Rooms

  @create_attrs %{twilio_room_sid: "some twilio_room_sid"}
  @update_attrs %{twilio_room_sid: "some updated twilio_room_sid"}
  @invalid_attrs %{twilio_room_sid: nil}
  ...
  describe "update room" do
    ...
    test "redirects when data is valid", %{conn: conn, room: room} do
      ...
      assert html_response(conn, 200) =~ "some updated twilio_room_sid"
    end
